...
namespace xameleon {
    ...
    protected:
        access_t    rights;
    public:
        virtual void process_req(https_session_t* session) = 0;
    ...
    http_action_t* find_http_action(http_request_t & requesr);

    /* Built-in actions */
    class static_page_action : public http_action_t {
        void process_req(https_session_t* session);
    public:
    ...
    class proxy_action: public http_action_t {
        ...
        void proxy_loop(https_session_t* session);
    public:
